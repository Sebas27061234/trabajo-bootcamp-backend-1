...
SELECT c.Nombre as Curso,p.Nombre as Profesor, c.Precio as Precio FROM curso_has_profesor as cp inner join profesor as p on cp.Profesor_idProfesor = p.idPofesor 
...
Select a.Nombre,a.DNI,a.Celular,a.Email from alumno_curso as ac inner join curso as c 
