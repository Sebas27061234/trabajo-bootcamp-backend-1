...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `dbcolegio_preg3` ;

-- -----------------------------------------------------
-- Schema dbcolegio_preg3
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `dbcolegio_preg3` DEFAULT CHARACTER SET utf8 ;
USE `dbcolegio_preg3` ;

-- -----------------------------------------------------
-- Table `dbcolegio_preg3`.`Pofesor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`Pofesor` ;

CREATE TABLE IF NOT EXISTS `dbcolegio_preg3`.`Pofesor` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`Curso` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`Nosotros` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`Alumno` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`Matricula` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `dbcolegio_preg3`.`DetalleMatricula` ;
